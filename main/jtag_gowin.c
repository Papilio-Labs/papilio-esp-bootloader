 ...
 *
 * Ported verbatim from FPGA-Companion/src/esp32/jtag_gowin.c (Phase 2, see
 * papilio-works/plans/2026-09-21-papilio-esp-bootloader.md). Direct bitstream
 * programming - no SVF conversion required. Works with native .fs/.bin files
 * from Gowin tools.
 */
