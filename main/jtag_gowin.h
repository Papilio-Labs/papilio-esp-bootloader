 ...
 *
 * Ported verbatim from FPGA-Companion/src/esp32/jtag_gowin.h (Phase 2, see
 * papilio-works/plans/2026-09-21-papilio-esp-bootloader.md). FPGA-Companion
 * keeps its own unmodified copy until Phase 6 strips it out there -- this
 * loader copy and that one intentionally coexist for now.
 *
 * Directly programs .fs/.bin bitstream files to FPGA SRAM via JTAG.
